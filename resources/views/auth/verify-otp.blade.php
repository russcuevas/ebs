    ...
    <div class="auth-form-panel text-center">
        ...
        <form method="POST" action="{{ route('verification.verify') }}" novalidate>
            ...
            <div class="mb-3">
                <input type="text" 
                       ...
                       placeholder="------" 
                       value="{{ old('otp') }}" 
                       style="letter-spacing: 12px; height: 56px; border-radius: 8px;" 
                       required 
                       autofocus 
        ...
        <div class="d-flex justify-content-between align-items-center pt-2 border-top">
            <form method="POST" action="{{ route('verification.resend') }}" class="m-0">
                @csrf
                <button type="submit" class="btn btn-link p-0 small text-decoration-none fw-semibold" style="color: #7B1113;">
